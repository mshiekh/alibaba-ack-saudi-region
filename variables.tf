...
variable "ack_name_prefix" {
  description = "The ack cluster name prefix used to create managed kubernetes cluster."
  type        = string
  default     = "terraform-ack"
}
...
variable "cluster_kubeconfig" {
  description = "The path of cluster kubeconfig, like ~/.kube/cluster-ca-cert.pem"
  type        = string
  default     = "~/.kube/config"
}
